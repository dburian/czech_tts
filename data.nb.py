...
# %%
data = pd.read_csv('/home/dburian/downloads/cv-corpus-19.0-2024-09-13/cs/train.tsv', sep='\t')
...
def _duration(mp3_path: str) -> float:
    wav, sr = torchaudio.load(f"/home/dburian/downloads/cv-corpus-19.0-2024-09-13/cs/clips/{mp3_path}")
